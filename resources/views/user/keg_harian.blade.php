							...
							<div class="card">
								<div class="card-header">
									...
									<div class="col-md-4">
											...
											<select name="tahun" id="e1" class="form-control select-search mb-1">
										...
										<div class="col-md-4">
											...
											<select name="bulan" id="e2" class="form-control select-search mb-1">
												@php 
										...
										<div class="col-md-4">
											...
											<select name="karyawan" id="e3" class="form-control mb-1 pt-2 pb-1">
											</select>
										</div>
										@php } @endphp
										<div class="col-md-3">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js" integrity="sha512-2ImtlRlf2VVmiGZsjm9bEyhjGW4dU7B6TNwh/hx/iSByxNENtj3WVE6o/9Lj4TJeVXPi4bnOIMXFIJJAeufa0A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
	...
	$(document).ready(function() { 
		...
		var table =	$('#basic-datatables').DataTable({
            ...
            "bAutoWidth": true,
            "ordering": false,
            "sAjaxSource": '{{ URL::to('api/user/kegharian') }}',
            "aoColumns": [
                { "mData": "tgl",className: 'text-center' }, 
				{ "mData": "foto_keg",
                    className: 'text-center', 
                    render: function (data) {
                        data = '<img src="{{ URL::to('images') }}/'+data+'" style="width:100px" />';
                        return data;
                    }
                },
                { "mData": "laporan_keg",className: 'text-center' }, 
				{ "mData": "kendala",className: 'text-center' }, 
				{ "mData": "solusi",className: 'text-center' }, 
		...
		function searchLoad(){
			...
			var table = $('#basic-datatables').DataTable({
				...
				"bAutoWidth": true,
				"ordering": false,
				"sAjaxSource": '{{ URL::to('api/kegharian-search') }}',
				"sAjaxDataProp": "data",
