...
<script >
	...
	function getTugas() {
		var table =	$('#basic-datatables').DataTable({
            ...
            "ordering": false,
			"language": {
				"emptyTable": "Belum ada tugas yang diterima"
				},
            "sAjaxSource": '{{ URL::to('api/tugas/user') }}',
            "aoColumns": [
				...
				{ "mData": "tgl_deadline",
					...
					var today = new Date();
					var jam = new Date().toLocaleTimeString('en-GB', { hour: "numeric", 
                                             minute: "numeric"});
					var dd = String(today.getDate()).padStart(2, '0');
					var mm = String(today.getMonth() + 1).padStart(2, '0'); //January is 0!
					var yyyy = today.getFullYear()
					today = dd + '/' + mm + '/' + yyyy + ' ' + jam;
					
					// if(data > today){
					// 	$('#ubah').addClass('disabled');
					// 	$('#ubah').attr('href','#')
					// }
                ...
                },
				{
                    ...
                    className: 'text-center',
                    render: function (data) {
                        data ='<div class="dropdown"> <button class="btn btn-link btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-ellipsis-vertical fa-xl text-dark"></i></button><div class="dropdown-menu" aria-labelledby="dropdownMenuButton"><a class="dropdown-item" id="ubah" href="/isi-tugas/'+ data +'"><i class="fa-solid fa-pen pr-2"></i> Ubah</a><a class="dropdown-item" id="btn-hapus" href="#" data-id='+ data +'"><a class="dropdown-item" href="/detail-tugas/'+ data +'"><i class="fa-solid fa-eye pr-2"></i>Detail</a></div></div>'
                        return data;
                    }
                }              
            ],
