...
<script >
	...
	function getAbsen() {
		var table =	$('#basic-datatables').DataTable({
            ...
            "ordering": false,
			"language": {
				"emptyTable": "Anda belum pernah mengajukan permohonan tidak hadir"
			},
            "sAjaxSource": '{{ URL::to('api/user/absen') }}',
            "aoColumns": [
				...
				{ "mData": "ket_absen" }, 
				{
                    ...
                    render: function (data) {
						if (data == "Dikonfirmasi"){
                       	 	data ='<i class="fa-solid fa-circle-check fa-xl text-success"></i>'
						} else if (data == "Ditolak"){
							data ='<span class="badge badge-danger">' + data + '</span>'
						} else {
							data ='<i class="fa-solid fa-clock fa-xl text-danger"></i>'
						}
                          return data;
                    }
                },
	...
	function validasi(id){
		...
		$.ajax({
            ...
            success: function (response) {
				...
				$('#ket').html(response.data.ket_absen);
